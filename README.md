# docker-sq-instalador
Contenedor Docker para instalar un entorno de desarrollo Toba y un entorno Node.js con Nvm (Node Version Manager).
...
```
docker build -t="siutoba/docker-sq-instalador" .
```
